...
import { useForgotPaswwordInstructorMutation } from "../../../redux/api/instructor/auth";
...
export function Component() {
  ...
  useEffect(() => {
    if (isSuccess && data) {
      ...
      navigate(`/instructor/otp-verify?email=${formData.email}`);
    }
  }, [isSuccess, data]);
...
Component.displayName = "InstructorForgotPassword";
