                        ...
                        <div className="resetpasssucss">
                            <div className="resetpasssucssInner">
                                <div className="contentBlock">
                                    ...
                                    <p className="mainText">Hi {fullName} 👋, your profile is under review. Please look out for our response via the email address you provided.</p>
                                </div>
                                <div>
...
Component.displayName = "signupSuccess";
