...
export function Component() {
  return (
    <>
      <Seo title="Terms of Service" metaName="Metaname">
        <div className="subpageBanner">
          <div className="container">
            ...
            <h4>
              ...
              information. By using our services, you agree to the collection
          ...
          <div className="container">
            <div className="contentBlock">
              ...
              <p className="subTextThree">
                <strong>Personal Data:</strong> We collect personal data you
                provide when you register, such as your name, email address, and
                other contact details.
                <br />
                <strong>Usage Data:</strong> Information on how you use
                Lightforth, including access times, viewed pages, and courses
                engaged with.
                <br />
            ...
            <div className="contentBlock">
              ...
              <p className="subTextThree">
                ...
                and to deliver tailored content and service offerings.
              </p>
            </div>
            <div className="contentBlock">
            ...
            <div className="contentBlock">
              ...
              <p className="subTextThree">
                We value your trust in providing us with your Personal Data, and
