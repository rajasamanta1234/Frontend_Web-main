...
import { resetPassword } from "@/validation/student/auth";
import { handelError } from "@/helpers/common";
import { useResetPasswordStudentMutation } from "@/redux/api/student/auth";
...
import { resetPasswordTwo } from "../../../validation/student/auth";
...
export function Component() {
  ...
  useEffect(() => {
    if (isSuccess && data) {
      ...
      navigate(
        `/student/reset-password-success?fullName=${data?.data?.fullName}`
      );
    }
  }, [isSuccess, data]);
...
Component.displayName = "StudentResetPassword";
