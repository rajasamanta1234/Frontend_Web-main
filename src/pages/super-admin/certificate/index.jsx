...
} from "@/redux/api/super-admin/certificates";
...
export function Component() {
  ...
  const handleChangeStatus = async (event) => {
    try {
      ...
      await changeStatus({
        id: intConvertedIds, // mandatory
        isApproved: currentOperation.toUpperCase(), // mandatory APPROVED/REJECTED/DELETED
        rejectionReason: "",
      });
    } catch (error) {
      console.log(error);
  ...
  return (
    <AuthGuard>
      <Seo title="Certificates" metaName="Metaname" metaTags={metaTags}>
...
Component.displayName = "SuperAdminCertificates";
